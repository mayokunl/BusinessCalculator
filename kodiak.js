function calculateValuation() {
    ...
    const cogs = [
      parseFloat(document.getElementById('2024-cogs').value) || 0,
      parseFloat(document.getElementById('2023-cogs').value) || 0,
      parseFloat(document.getElementById('2022-cogs').value) || 0
    ];
    const otherExpenses = [
    ...
    // Net Score
    const netScore = (totalSales/3) - (totalCOGS/3) - (totalExpenses/3);
